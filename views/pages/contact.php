			...
			<div class="row">
				<div class="col-md-10 col-md-push-1">
					<div class="row">
						<div class="card">
							<div class="card-body">
								<div class="col-md-12 col-md-offset-1 col-md-pull-1 animate-box"
									...
									<form>
										...
										<div class="form-group">
											...
											<select name="country" class="form-control" id="" required>
												...
												<option value="App Developer/Publisher">App Developer/Publisher</option>
												<option value="DSP">DSP</option>
												<option value="Mobile Website Publisher">Mobile Website Publisher
												</option>
												<option value="Other">Other</option>
												<option value="Press">Press</option>
												<option value="SSP">SSP</option>
												<option value="Student">Student</option>
												<option value="Trading Desk">Trading Desk</option>
											</select>
										</div>
										<div class="form-group">
